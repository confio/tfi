...
This is mainly used from tfi factory contract to create new tfi pair. It initialize all swap created parameters which can be updated later with owner key.
