...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        tfi_factory: HumanAddr("tfifactory".to_string()),
    };
    ...
    assert_eq!("tfifactory", config.tfi_factory.as_str());
}
...
fn execute_swap_operation() {
    ...
    deps.querier
        .with_tfi_pairs(&[(&"uusdasset".to_string(), &HumanAddr::from("pair"))]);
    ...
    deps.querier
        .with_tfi_pairs(&[(&"assetuusd".to_string(), &HumanAddr::from("pair"))]);
