...
This is a collection of common types and the queriers which are commonly used in tfi contracts.
...
It also provides the query interface to query avaliable tfi pair contract info. Any contract can query pair info to tfi factory contract.
...
It returns liquidity token contract address of tfi pair contract. 
